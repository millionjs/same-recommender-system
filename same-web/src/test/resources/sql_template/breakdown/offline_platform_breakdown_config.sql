create table offline_platform_breakdown_config
(
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT = 'Breakdown任务配置信息。';

-- alter table offline_platform_breakdown_task
